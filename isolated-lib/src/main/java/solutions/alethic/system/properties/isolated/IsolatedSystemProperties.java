 ...
 */
public class IsolatedSystemProperties {

	/**
	 * Returns a {@link IsolatedPropertyEnvironment} that manages system properties.
	 * <p>
	 ...
	 * </p>
	 * 
	 * @return a new {@link IsolatedPropertyEnvironment}
	 */
	public static IsolatedPropertyEnvironment newPropertyEnvironment() {
		return new IsolatedPropertyEnvironment();
	}

	private IsolatedSystemProperties() {
