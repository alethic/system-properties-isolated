 ...
 * </p>
 */
public class IsolatedPropertyEnvironment implements AutoCloseable {

	private IsolatedDelegatingProperties propertyStore;

	private final Properties originalProperties;

	public IsolatedPropertyEnvironment() {
		originalProperties = System.getProperties();
		propertyStore = new IsolatedDelegatingProperties(originalProperties);
	 ...
	 * See the documentation for {@link IsolatedPropertyEnvironment} for more details.
	 * 
	 * This method is just a convince method to help making the intention clear that
	 * the value for the system property is isolated. The same effect can be achieved
	 * by calling <code>System#setProperty(String, String)</code> while a
	 * {@link IsolatedPropertyEnvironment} is active.
	 * 
