...
public class IsolatedDelegatingProperties extends Properties {

	private static final long serialVersionUID = 1L;

	private Properties baseline;

	private final InheritableThreadLocal<Properties> environmentProperties = new InheritableThreadLocal<Properties>() {
		protected Properties initialValue() {
			return baseline;
		};
	};

	public IsolatedDelegatingProperties(Properties baseline) {
